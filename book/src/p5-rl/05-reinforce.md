...
**Goal.** Implement REINFORCE and watch variance drop with a baseline.

**Covers.** Monte Carlo policy gradients; baselines and their unbiasedness; reward-to-go; advantage as the general form.
