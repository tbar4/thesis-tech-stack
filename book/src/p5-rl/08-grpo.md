...
**Goal.** Derive GRPO from PPO and catalogue its pathologies and fixes.

**Covers.** Group-relative advantage; dropping the critic; KL-to-reference (k3 estimator); token vs sequence aggregation; length bias, std collapse, DAPO-style fixes, clip-higher.
