...
**Goal.** Build the reusable evalstats module every later comparison depends on.

**Covers.** Eval variance sources; seeds and resampling; bootstrap CIs (full derivation); paired-difference tests; multiple-comparison correction; power analysis.
