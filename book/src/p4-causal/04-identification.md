...
**Goal.** Compute an adjusted model-vs-model comparison and contrast with the naive one.

**Covers.** Adjustment sets; backdoor criterion; front-door logic; what is and isn't identifiable in typical eval comparisons.
