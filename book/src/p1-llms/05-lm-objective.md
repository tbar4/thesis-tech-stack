...
**Goal.** Make the next-token objective and its loss curves concrete.

**Covers.** Next-token prediction, cross-entropy, perplexity, label shifting, why loss curves look like they do.
