...
**Goal.** Explain quantization error and the format zoo mathematically, then measure the perplexity cost.

**Covers.** Uniform quantization error; group-wise scales; AWQ vs GPTQ conceptually and mathematically; FP8; MXFP4 (gpt-oss); calibration data.
